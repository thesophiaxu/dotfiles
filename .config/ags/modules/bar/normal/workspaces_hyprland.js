    ...
    return DrawingArea({
        ...
        attribute: {
            ...
            updateMask: (self) => {
                ...
                // console.log('Workspaces:', Hyprland.workspaces);
                // console.log('Active workspace:', Hyprland.active.workspace);
                // console.log('Active workspace id:', Hyprland.active.workspace.id);
        ...
        setup: (area) => area
            ...
            .on('draw', Lang.bind(area, (area, cr) => {
                ...
                area.set_size_request(workspaceDiameter * area.attribute.drawAmount, -1);
                ...
                layout.set_text("0".repeat(area.attribute.drawAmount.toString().length), -1);
                ...
                for (let i = 1; i <= area.attribute.drawAmount; i++) {
                ...
                for (let i = 1; i <= area.attribute.drawAmount; i++) {
                    ...
                    // console.log(area.attribute.windowCounts);
                    // console.log(i);
                    layout.set_text(`${area.attribute.windowCounts[i - 1]}`, -1);
                    const [layoutWidth, layoutHeight] = layout.get_pixel_size();
